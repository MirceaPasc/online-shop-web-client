        ...
        return `<div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="${product.id}" rel="nofollow" href="/online-shop-web-client/cart.html">Add to cart</a>
                        </div>                       
                    </div>
                   </div>`
    },
